...
public class FileHolder implements Parcelable, Comparable<FileHolder> {
	 ...
	 * 
	 * @param f
	 *            The file this object will hold.
	 * @param i
	...
	/**
	 * Gets the icon representation of this file. Creates it if it's not already
	 * stored. -- In case of loss through parcel-unparcel.
	 * 
	 * @return The icon.
	 */
	...
	/**
	 * @param recursive
	 *            Whether to return size of the whole tree below this file
	 *            (Directories only).
	 */
