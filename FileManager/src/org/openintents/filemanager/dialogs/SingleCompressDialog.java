...
public class SingleCompressDialog extends DialogFragment implements
		Overwritable {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.e("SingleCompressDialog", "onCreate");
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		Log.e("SingleCompressDialog", "onCreateDialog");
	...
	private void compress(final String zipname) {
		tbcreated = new File(mFileHolder.getFile().getParent() + File.separator
				+ zipname + ".zip");
		if (tbcreated.exists()) {
			...
			mCompressManager.setTask();
			Log.e("setTask", "DONE");
			mCompressManager.setTargetFragment(getTargetFragment(),
					SimpleFileListFragment.TASK_FRAGMENT);
			Log.e("setTargetFragment", "DONE");
			mCompressManager.show(SimpleFileListFragment.mFM,
					SimpleFileListFragment.TASK_FRAGMENT_TAG);
			Log.e("show", "DONE");
		}
	}

	public static File tbcreated;
