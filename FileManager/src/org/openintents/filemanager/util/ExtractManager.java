...
public class ExtractManager {
	...
	private class ExtractTask extends AsyncTask<Object, Void, Integer> {
		...
		protected void onPostExecute(Integer result) {
			...
			if (result == error) {
				Toast.makeText(context, R.string.extracting_error,
						Toast.LENGTH_SHORT).show();
			} else if (result == success) {
				Toast.makeText(context, R.string.extracting_success,
						Toast.LENGTH_SHORT).show();
			}
	...
	public ExtractManager setOnExtractFinishedListener(
			OnExtractFinishedListener listener) {
