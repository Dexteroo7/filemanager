...
/**
 * Simple recents suggestion provider. Not currently used, as we use a custom
 * one. To use just point the searchable.xml to this provider. It's way faster,
 * but disables access of the QuickSearchBox to OIFM.
 * 
