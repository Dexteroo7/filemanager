...
public class FileManagerActivity extends DistributionLibraryFragmentActivity
		implements
		org.openintents.filemanager.lists.SimpleFileListFragment.Callbacks {
	...
	public void onTaskFinished(boolean success) {
		...
		if (success == false)
			Toast.makeText(this, "Compression Failed!", Toast.LENGTH_LONG)
					.show();
		else
			Toast.makeText(this, "Compression Done!", Toast.LENGTH_LONG).show();
	}
}
